...
in
{
  sops = {
    ...
    secrets = {
      ...
      let
        mkSecrets = id: [
          { name = "prompt-${id}-filename"; value = { sopsFile = promptsFile; format = "yaml"; key = "prompts.${id}.filename"; owner = "bdsqqq"; mode = "0400"; }; }
          { name = "prompt-${id}-content";  value = { sopsFile = promptsFile; format = "yaml"; key = "prompts.${id}.content";  owner = "bdsqqq"; mode = "0400"; }; }
        ];

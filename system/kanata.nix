...
in
{
  ...
  config = lib.mkIf cfg.enable (lib.mkMerge [
    ...
    # Linux-specific (systemd service already provided by desktop host)
    (lib.mkIf isLinux {
      # services.kanata already configured in hosts/desktop/default.nix
      # this module just provides common config
    })
  ]);
}

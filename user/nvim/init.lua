...
vim.api.nvim_create_autocmd("LspAttach", {
	...
	callback = function(ev)
		...
		map(
			"n",
			"gW",
			tele("lsp_dynamic_workspace_symbols") or vim.lsp.buf.workspace_symbol,
		...
		map(
			"n",
			"<leader>lt",
			tele("lsp_type_definitions") or vim.lsp.buf.type_definition,
			"lsp: goto [t]ype definition"
		)
		map(
			"n",
			"<leader>ls",

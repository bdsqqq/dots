...
- Do NOT use the delegate tool unless the task genuinely requires independent, parallelizable work across different parts of an application. Prefer doing the work directly and sequentially yourself — you retain full context and produce better results. Never spawn a single delegate call for work you can do yourself. Never use delegate for simple or small changes.

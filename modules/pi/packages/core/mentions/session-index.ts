    ...
    it("extracts first user message and touched files from a branch", () => {
            ...
            },
            {
              ...
              message: {
                ...
                content: [
                  {
                    type: "text",
                    text: "check @modules/pi/packages/core/mentions/index.ts and /tmp/demo.ts",
                  },
                ],
              },
            },
      ...
      expect(branches[0]).toEqual(
        expect.objectContaining({
          ...
          firstUserMessage:
            "check @modules/pi/packages/core/mentions/index.ts and /tmp/demo.ts",
          filesTouched: expect.arrayContaining([
            "modules/pi/packages/core/mentions/index.ts",
            "/tmp/demo.ts",

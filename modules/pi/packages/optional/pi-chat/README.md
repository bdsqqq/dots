Vendored from [earendil-works/pi-chat](https://github.com/earendil-works/pi-chat) at commit [`9adbd29b40ee27ff1decf0fc87cbe180b40924f5`](https://github.com/earendil-works/pi-chat/commit/9adbd29b40ee27ff1decf0fc87cbe180b40924f5). Local compatibility and sandbox-mount adaptations are maintained in this repository.

# pi-chat

Vendored from `earendil-works/pi-chat@9adbd29b40ee27ff1decf0fc87cbe180b40924f5`.
This copy tracks the current Pi package names and adds a host-configured,
read-only `/commonplace` mount.
...
- `PI_CHAT_COMMONPLACE_ROOT` set to an absolute, existing host directory mounted read-only at `/commonplace`
...
- `/commonplace` → `PI_CHAT_COMMONPLACE_ROOT`, read-only (`EROFS` on writes)

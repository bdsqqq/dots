...
import { extractContractCallbacks } from "./callbacks.js";
...
export function statementsOf(node: SyntaxNode): SyntaxNode[] {
...
function extractFromTree(
  ...
  return extractContractCallbacks(file, tree, functions, collectStatements);
}

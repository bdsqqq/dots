/*
  ...
  Usage:
    let syncthing = import ./modules/syncthing/lib.nix;
    in {
...
rec {
  ...
  */
  devices = {
    ...
    htz-relay = {
      ...
      addresses = [
        "tcp://htz-relay:22000"
        "quic://htz-relay:22000"
      ];
    };
    mmn-m4 = {
      id = "V4DUGAF-IQ4VWXJ-SG34D6W-GQVAV2M-MLYN5N4-SP3EGGY-UM54TID-4U5PGQF";
      addresses = [
        "tcp://mmn-m4:22000"
        "quic://mmn-m4:22000"
      ];
  ...
  */
  ...
  mkStignore =
    ...
    let
      ...
      transformLine = line: if builtins.hasAttr line deletePatternSet then "(?d)(?i)${line}" else line;
    in
  ...
  */
  mkFolder =
    name: path: deviceNames: extraConfig:
    let
      baseConfig = {
        enable = true;
        id = folderIds.${name};
  ...
  */
  folderFor =
    name: home: isDarwin: deviceNames: extraConfig:

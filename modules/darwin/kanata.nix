...
# VirtualHIDDevice daemon - manually managed to avoid keyboard lockup
    # Use kanata-setup to start safely
...
echo "Starting kanata for 60 seconds..."
    ...
    environment.etc."kanata/kanata.kbd".source = ../shared/kanata.kbd;
